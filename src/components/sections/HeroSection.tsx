...
const AvailableForNewProjects = () => {
  return (
    <div id="hero-section" className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
      <div className="lg:col-span-7 flex flex-col justify-center space-y-6 text-left">
        ...
        <div className="flex flex-wrap gap-4 pt-4">
          <a href="#projects" className="group relative px-8 py-4 rounded-xl font-heading font-medium tracking-wide bg-gradient-to-r from-blue-500 to-cyan-400 text-slate-950 shadow-[0_0_30px_rgba(59,130,246,0.4)] hover:shadow-[0_0_40px_rgba(59,130,246,0.6)] transition-all duration-300 transform hover:-translate-y-0.5 flex items-center gap-2">
            Explore Work
